...
function render(list) {
    ...
    <div class="card" onclick="location='anime-detail.html?id=${a.id}'" role="link" tabindex="0">
        ...
        <div class="card-content">
            ...
            <div class="card-status ${a.status ? a.status.toLowerCase() : ''}">
...
function filtro() {
    ...
    const res = typeof animes !== 'undefined' ? animes.filter(a => {
        const mQ = a.title.toLowerCase().includes(q) || (a.genres && a.genres.some(gen => gen.toLowerCase().includes(q)));
        const mG = g === "" || (a.genres && a.genres.includes(g));
...
const fgContainer = document.getElementById('fg-container') || document.getElementById('fgContainer');
const fgCanvas = document.getElementById('fg-canvas') || document.getElementById('fgCanvas');
const fgVideo = document.getElementById('fg-video') || document.getElementById('fgVideo');
const fgCtx = fgCanvas ? fgCanvas.getContext('2d') : null;
const bgVideo = document.getElementById('bg-video');

const videos = [
    { src: 'https://res.cloudinary.com/dbcqcai1q/video/upload/v1739818318/1_t9dksd.mp4', start: 5.0, duration: 2.0 },
    { src: 'https://res.cloudinary.com/dbcqcai1q/video/upload/v1739818335/2_txyrlm.mp4', start: 0.1, duration: 3.5 },
    { src: 'https://res.cloudinary.com/dbcqcai1q/video/upload/v1739818359/3_h1qgct.mp4', start: 11.5, duration: 3.0 },
    { src: 'https://res.cloudinary.com/dbcqcai1q/video/upload/v1739818355/4_tzf0h8.mp4', start: 2.3, duration: 3.0 },
    { src: 'https://res.cloudinary.com/dbcqcai1q/video/upload/v1739818386/5_szg9t1.mp4', start: 22.0, duration: 4.0 },
    { src: 'https://res.cloudinary.com/dbcqcai1q/video/upload/v1739818400/6_ntv3in.mp4', start: 10.0, duration: 3.0 },
    { src: 'https://res.cloudinary.com/dbcqcai1q/video/upload/v1739818417/7_f56yig.mp4', start: 4.0, duration: 3.0 }
];
...
function playVideoClip(vInfo) {
    ...
    fgVideo.play().then(() => {
        if(fgContainer) fgContainer.style.display = 'block';
...
function drawFrame() {
    if (fgVideo && fgCtx && !fgVideo.paused && !fgVideo.ended) {
