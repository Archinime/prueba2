...
const CACHE_STATIC = 'archinime-static-v4';
const CACHE_DYNAMIC = 'archinime-dynamic-v4';
const CACHE_IMAGES = 'archinime-images-v4';
const CACHE_FONTS = 'archinime-fonts-v4';
