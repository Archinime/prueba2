...
const CACHE_STATIC = 'archinime-static-v7';
const CACHE_DYNAMIC = 'archinime-dynamic-v7';
const CACHE_IMAGES = 'archinime-images-v7';
const CACHE_FONTS = 'archinime-fonts-v7';
