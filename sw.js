...
const CACHE_STATIC = 'archinime-static-v3';
const CACHE_DYNAMIC = 'archinime-dynamic-v3';
const CACHE_IMAGES = 'archinime-images-v3';
const CACHE_FONTS = 'archinime-fonts-v3';
