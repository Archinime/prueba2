...
const CACHE_STATIC = 'archinime-static-v2';
const CACHE_DYNAMIC = 'archinime-dynamic-v2';
const CACHE_IMAGES = 'archinime-images-v2';
const CACHE_FONTS = 'archinime-fonts-v2';
