...
const CACHE_STATIC = 'archinime-static-v8';
const CACHE_DYNAMIC = 'archinime-dynamic-v8';
const CACHE_IMAGES = 'archinime-images-v8';
const CACHE_FONTS = 'archinime-fonts-v8';
